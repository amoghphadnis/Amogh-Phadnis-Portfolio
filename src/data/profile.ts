...
export const profile: Profile = {
  name: 'Amogh Anand Phadnis',
  title: 'Software Developer',
  tagline: 'Enterprise Applications • Manufacturing Systems • Workflow Automation',
  headline: 'Software Developer specializing in Enterprise Applications, Manufacturing Systems, Workflow Automation, and Full-Stack Engineering.',
  location: 'Kitchener, Ontario, Canada',
  email: 'amoghphadnis20@gmail.com',
